...
export default function GNB() {
  ...
  return (
    <nav className="w-full border-b">
      <div className="flex justify-between p-5 items-center max-w-screen-xl mx-auto">
        <Link
          href="/"
          className="bg-red-500 text-white w-14 h-14 justify-center rounded-full font-bold flex flex-col items-center"
        >
          <IconPizza size={24} />
        ...
        <div className="flex gap-7 items-center text-gray-800 font-semibold">
          ...
          {id ? (
            <>
              <Link href="/create" className="bg-rose-500 text-white px-3 py-2 rounded-2xl">
                식당 등록
              </Link>
              <Link href="/profile">
                <Image
